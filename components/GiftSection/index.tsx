  ...
  return (
    <section className="section" id="kado">
      <div className="container mx-auto flex flex-col">
        <div className="w-full bg-white mx-auto px-12 rounded-xl py-20 border border-zinc-300 border-t-[5px] border-t-zinc-800 shadow-xl text-center flex flex-col items-center">
          <h2
            className="sm:text-6xl text-5xl font-secondary font-bold text-zinc-800 leading-tight mb-4"
            data-aos="fade-down"
            data-aos-delay="500"
          >
            Kirim Kado
          ...
          <p
            className="text-zinc-600 sm:text-[18px] max-w-[750px] mx-auto mb-6"
            data-aos="fade-down"
            data-aos-delay="800"
          >
