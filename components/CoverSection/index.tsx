  ...
  return (
    <section className="flex justify-center items-center fixed top-0 left-0 w-full h-screen bg-white z-[999]">
      <div className="container mx-auto h-full flex flex-col justify-center items-center">
        <h3
          className="sm:text-[32px] text-[24px] font-medium text-zinc-800 leading-tight mb-4"
          data-aos="fade-down"
        >
          The Wedding of
        </h3>
        <h1
          className="sm:text-8xl text-6xl text-center font-secondary text-zinc-800 leading-tight mb-2"
          data-aos="fade-down"
          data-aos-delay="300"
        >
          Mahesa & Herla
      ...
      <p className="absolute bottom-10 text-sm opacity-80">By Firman</p>
    </section>
  );
};
